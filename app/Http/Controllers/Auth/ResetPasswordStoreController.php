    ...
    */
    ...
    public function checkToken(Request $request)
    {
        $passwordReset = DB::table('password_resets')
            ...
            ->first();
        if (!Hash::check($request['token'], $passwordReset->token) || Carbon::parse($passwordReset->created_at)->addMinutes(config('auth.passwords.stores.expire'))->isPast()) {
    ...
    public function reset(Request $request)
    {
        ...
        $user = Store::where('email', $request['email'])->get();
